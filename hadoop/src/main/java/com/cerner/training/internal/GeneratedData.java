...
public class GeneratedData {
    ...
    /**
     * Alternate data generated for the lab
     */
    public static Map<String, Person> morePeople = new HashMap<String, Person>();
    ...
    static {
        ...
        morePeople.putAll(people);
        morePeople.put("iron man", Person.newBuilder().setName("iron man").setFriends(Collections.<String> emptyList()).build());
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        write(morePeople.values(), new File("target/more_people.avro"));
    }
